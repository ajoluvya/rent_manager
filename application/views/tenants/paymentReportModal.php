<div class="modal fade" id="paymentReportModal">
    <div class="col-lg-8 col-lg-offset-2">
        <div class="modal-content" data-bind="with: payment_report">
                            ...
                            <div data-bind="css: {'col-md-12':!(passport_photo&&passport_photo!=''),'col-md-7':passport_photo&&passport_photo!=''}">
                                <div class="table-responsive">
                                    <table class="table table-condensed table-bordered">
                                        <tbody>
                                            <tr><th>Tenant names</th><td data-bind="text: names"></td></tr>
                                            <tr><th>Phone 1</th><td><a data-bind="attr: {href:'tel:'+phone1}, text: phone1" title="Call now"></a></td></tr>
                                            <tr><th>Phone 2</th><td><a data-bind="attr: {href:'tel:'+phone2}, text: phone2" title="Call now"></a></td></tr>
                                            <tr><th>Home address</th><td><span data-bind="text: home_address"></span></td></tr>
                                            <tr><th>District</th><td data-bind="text: district"></td></tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="table-responsive">
                                <table class="table table-condensed table-bordered">
                                    <tbody>
                                        ...
                                        <tr><th>Last payment</th><td data-bind="text: moment(end_date,'X').format(parseInt(time_interval_id)<3?'hh:mm A Do-MMM-YYYY':(parseInt(billing_starts)==1?'MMM-YYYY':'Do-MMM-YYYY'))"></td></tr>
                                        <tr><th>Status</th><td data-bind="text: status"></td></tr>
                                    </tbody>
                                </table>
                            </div><!-- ./ table-responsive -->
                        </div><!-- ./ box-body -->
