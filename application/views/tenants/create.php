                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-8"><input type="text" class="form-control" id="names" name="names" value="<?php echo (set_value('names') != NULL) ? set_value('names') : (isset($tenant['names']) ? $tenant['names'] : ""); ?>" placeholder="Tenant names" required=""></div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group">
                                <div class="col-md-3"><label for="phone1">Phone Numbers</label></div>
                                <div class="col-md-4"><input type="text" class="form-control" id="phone1" name="phone1" value="<?php echo (set_value('phone1') != NULL) ? set_value('phone1') : (isset($tenant['phone1']) ? $tenant['phone1'] : ""); ?>" placeholder="Primary phone number" pattern="^(0|\+256)[2347]([0-9]{8})" data-pattern-error="Invalid phone number" required=""></div>
                                <div class="col-md-4"><input type="text" class="form-control" id="phone2" name="phone2" value="<?php echo (set_value('phone2') != NULL) ? set_value('phone2') : (isset($tenant['phone2']) ? $tenant['phone2'] : ""); ?>" pattern="^(0|\+256)[2347]([0-9]{8})" data-pattern-error="Invalid phone number" placeholder="Optional, second phone number"></div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group">
                                <div class="col-md-3"><label for="id_card_no">ID Card</label></div>
                                <div class="col-md-4"><input type="text" class="form-control" id="id_card_no" name="id_card_no" value="<?php echo (set_value('id_card_no') != NULL) ? set_value('id_card_no') : (isset($tenant['id_card_no']) ? $tenant['id_card_no'] : ""); ?>" placeholder="Card number" required=""></div>
                                <div class="col-md-4">
