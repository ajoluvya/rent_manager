...
<script type="text/javascript">
	$(document).ready(function () {
		var PaymentModel = function(){
			...
			self.start_date = ko.observable('<?php echo mdate('%Y-%m-%d',((isset($tenancy['end_date'])&&$tenancy['end_date']!="")?$tenancy['end_date']:$tenancy['start_date'])+86400); ; ?>');
