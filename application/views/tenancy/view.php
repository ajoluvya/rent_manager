            ...
            <div class="panel-body">
                                ...
                                <h3 class="box-title"><?php echo $sub_title; ?></h3>
                                    ...
                                    <?php if ($_SESSION['role'] == 4 || $_SESSION['role'] == 3) { ?>
                                        <div class="pull-right">
                                            <a class="btn btn-sm btn-default" href="<?php echo site_url("tenancy/update/" . $tenancy['tenancy_id']); ?>" title="Edit house details">
                                                <i class="fa fa-edit"></i> Edit
                                            </a>
                                            <a href="<?php echo site_url("tenancy/del_tenancy/" . $tenancy['tenancy_id']); ?>" class="btn btn-sm btn-danger" title='Delete house details' onclick="return confirm_delete('<?php echo "this tenancy arrangement (REF#" . $tenancy['tenancy_id']; ?>)');"><i class="fa fa-trash"></i> Delete</a>
                                        </div>
                                    <?php } ?>
                            </div>
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="table-responsive">
                                        <table class="table table-condensed">
                                            ...
                                            <tr><th>Name(s)</th><td><?php echo $tenancy['names']; ?></td></tr>
                                ...
                                <?php if(isset($tenancy['passport_photo'])&& $tenancy['passport_photo'] != ""):?>
                                <div class="col-md-3"><img class="img-thumbnail img-responsive" src="<?php echo site_url("uploads/tenants/" . $tenancy['passport_photo']); ?>"/></div><!--col-md-3-->
                                <?php endif; ?>
                                <?php if(isset($tenancy['id_card_url'])&& $tenancy['id_card_url'] != ""):?>
                                <div class="col-md-3"><img class="img-thumbnail img-responsive" src="<?php echo site_url("uploads/tenants/" . $tenancy['id_card_url']); ?>"/></div><!--col-md-3-->
                                <?php endif; ?>
                            </div><!-- /.box-body -->
                        </div><!-- /.box -->
                    </div><!-- /.col-lg-12 -->
                    <?php $total_payments = 0;
                    if (!empty($payments)): //display the payments to this tenancy arrangement  
                        ?>
                        <div class="col-lg-7">
                            <div class="box box-solid">
                                <div class="box-header with-border">
                    ...
                    <?php foreach ($payments as $payment): ?>
                                            <tr>
                                                ...
                                                <td><?php $total_payments += $payment['amount'];
